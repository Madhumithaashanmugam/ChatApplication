...
# Import your custom functions and models
from services.auth import authenticate_user, create_access_token, timedelta
from models.users.schema import TokenData, UserDetails
...
async def login_for_access_token(
    ...
    try:
        ...
        # Prepare user details to include in the response
    ...
    # Handle specific HTTP exceptions (like authentication failures)
    except HTTPException as e:
        raise e
    
    # Handle general exceptions with a server error message
